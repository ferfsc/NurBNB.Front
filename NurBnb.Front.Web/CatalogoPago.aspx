<%@ Page Async="true" Language="C#" MasterPageFile="~/Index.Master" AutoEventWireup="true" CodeBehind="CatalogoPago.aspx.cs" Inherits="NurBnb.Front.Web.CatalogoPago" %>
...
<asp:Content ID="Contenido" ContentPlaceHolderID="ContentPlaceHolder" runat="server">
    <asp:UpdatePanel ID="updGeneral" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            <h1 id="hTitulo" runat="server" class="titulos">Formulario de Registro de Catálogo de Pago</h1>
            ...
            <div id="pnlRegistro" runat="server">
                ...
                <div id="cuentas_origen">
                    <ul uk-accordion>
                        <li class="uk-open">
                            <a class="uk-accordion-title uk-text-center" href="#">Lista de Catalogos de Pago</a>
                                        ...
                                        <ItemTemplate>
                                            <tr class="trSubTitulo_item uk-text-right uk-text-center@s">
                                                <td data-label="Catalogo" class="uk-text-left@s">
                                                    <span class="Etiqueta">
                                                        <asp:Label ID="lblCodigo" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "CatalogoId") %>' />
                                                    </span>
                                                </td>
                                                ...
                                                <td data-label="Porcentaje" class="uk-text-center@s">
                                                    <span class="Etiqueta">
                                                        <asp:Label ID="lblPorcentaje" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "Porcentaje") %>' />
                                                    </span>
                                                </td>
                                                <td data-label="Tipo" class="uk-text-center@s">
                                                    <span class="Etiqueta">
                                                ...
                                                <td data-label="Editar">
                                                    <span class="Etiqueta">
                                                        <asp:LinkButton ID="lnkEditar" runat="server" CssClass="link_saldo" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "CatalogoId") %>'
                    ...
                    <div class="uk-margin-small">
                        <div uk-grid class="uk-grid-small">
                            <div class="uk-width-1-2 uk-width-1-3@m">
                                ...
                                </asp:Label></div></div><div uk-grid class="uk-grid-small">
                            
                            <div class="uk-width-1-2 uk-width-1-3@m">
                                <asp:Label runat="server" CssClass="custom-dropdown">
                                    <asp:Label ID="Label1" CssClass="il_lb_campos uk-form-label texto_15" runat="server">Tipo</asp:Label>
                                    <asp:DropDownList ID="cmbTipo" runat="server" CssClass="customSelect uk-select uk-form-small" AppendDataBoundItems="true">
                                        <asp:ListItem Value="-1">Seleccionar</asp:ListItem>
                                        <asp:ListItem Value="1">Reserva</asp:ListItem>
                                        <asp:ListItem Value="0">Cobro</asp:ListItem>
                                    </asp:DropDownList>
                                </asp:Label></div><div class="uk-width-1-2 uk-width-1-3@m">
     <asp:Label runat="server" CssClass="custom-dropdown">
         <asp:Label ID="Label8" CssClass="il_lb_campos uk-form-label texto_15" runat="server">Porcentaje</asp:Label>
         <asp:TextBox ID="txtPorcentaje" runat="server" CssClass="uk-input uk-form-small claseMonto uk-text-left"/>
     </asp:Label></div></div></div><div class="uk-margin-small">
                        <div uk-grid class="uk-grid-small">
                            <div class="uk-width-1-2 uk-width-1-3@m">
                            </div>
                            <div class="uk-width-1-2 uk-width-1-3@m">
